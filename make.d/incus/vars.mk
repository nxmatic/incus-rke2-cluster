...
# Local build/artifact workspace lives under .local.d/var/run (tmpfs-backed) to avoid repo pollution and NFS issues (@codebase)
.incus.runtime.dir = $(var-dir)/run/distrobuilder/$(.incus.image.name)
...
.incus.image.pack.config = $(.incus.runtime.dir)/$(cluster.name)-pack.yaml
